...
//   根据IndexReader创建IndexSearcher查询索引
...
//   解析器，创建parser来确定要搜索的内容，第一个参数为搜索的域
...
//     创建Query表示搜索域为conteny包含UIMA文档
 ...
 147   */
  public static void doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query,
   ...
   // Collect enough docs to show 5 pages（根据TopDocs获取ScoreDoc对象）
...
//      根据searcher和ScoreDocs对象获取具体的Document对象
